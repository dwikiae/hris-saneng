...
- [ ] Karyawan — lanjutkan implementasi domain lengkap PKWT/PKWTT sesuai compliance.
  ...
  - [x] Phase D2-4b — backend foundation pendidikan, pengalaman kerja, dan notes/chatter append-only.
  - [x] Phase D2-4c — backend offboarding formal dengan checklist, employee inactive, dan kontrak superseded.
  - [ ] Phase berikutnya — prosedur termination/PHK khusus dan expiry natural PKWT.
...
- [x] Backend — Phase D2-4b Employee Detail foundation: endpoint pendidikan, pengalaman kerja, notes/chatter append-only, dan system note approval/kontrak.
- [x] Backend — Phase D2-4c Employee Offboarding: workflow offboarding, checklist, completion guard, employee inactive, kontrak superseded+archived, dan system note.
