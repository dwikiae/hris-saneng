...
use App\Http\Controllers\Api\V1\Employee\EmployeeOffboardingController;
use App\Http\Controllers\Api\V1\Employee\EmployeePhotoController;
use App\Http\Controllers\Api\V1\Employee\OffboardingChecklistController;
...
Route::prefix('v1')->middleware(['auth:sanctum', 'ip.whitelist'])->group(function () {
    ...
    Route::prefix('instance/companies')->group(function () {
        Route::get('/', [InstanceCompanyController::class, 'index']);
        Route::post('/', [InstanceCompanyController::class, 'store']);
        Route::get('{company}', [InstanceCompanyController::class, 'show']);
    ...
    Route::middleware('company.resolve')->group(function () {
        ...
        Route::prefix('employees')->group(function () {
            ...
            Route::get('{id}/education', [EmployeeEducationController::class, 'index']);
            ...
            Route::post('{id}/experience/{expId}/archive', [EmployeeExperienceController::class, 'archive']);
            Route::get('{id}/notes', [EmployeeNoteController::class, 'index']);
            Route::post('{id}/notes', [EmployeeNoteController::class, 'store']);
            Route::get('{id}/offboarding', [EmployeeOffboardingController::class, 'show']);
            Route::post('{id}/offboarding', [EmployeeOffboardingController::class, 'store']);
            Route::put('{id}/offboarding/{offId}', [EmployeeOffboardingController::class, 'update']);
            Route::post('{id}/offboarding/{offId}/complete', [EmployeeOffboardingController::class, 'complete']);
            Route::get('{id}/offboarding/{offId}/checklist', [OffboardingChecklistController::class, 'index']);
            Route::post('{id}/offboarding/{offId}/checklist', [OffboardingChecklistController::class, 'store']);
            Route::put('{id}/offboarding/{offId}/checklist/{itemId}', [OffboardingChecklistController::class, 'update']);
            Route::post('{id}/offboarding/{offId}/checklist/{itemId}/complete', [OffboardingChecklistController::class, 'complete']);
            Route::post('{id}/offboarding/{offId}/checklist/{itemId}/archive', [OffboardingChecklistController::class, 'archive']);
            Route::get('{id}/contracts', [EmployeeContractController::class, 'index']);
            Route::post('{id}/contracts', [EmployeeContractController::class, 'store']);
            Route::get('{id}/contracts/{contractId}', [EmployeeContractController::class, 'show']);
            Route::put('{id}/contracts/{contractId}', [EmployeeContractController::class, 'update']);
            Route::post('{id}/contracts/{contractId}/approve', [EmployeeContractController::class, 'approve']);
            Route::post('{id}/contracts/{contractId}/archive', [EmployeeContractController::class, 'archive']);
            Route::get('{id}/family', [EmployeeFamilyController::class, 'index']);
            Route::post('{id}/family', [EmployeeFamilyController::class, 'store']);
            Route::put('{id}/family/{familyId}', [EmployeeFamilyController::class, 'update']);
            Route::post('{id}/family/{familyId}/archive', [EmployeeFamilyController::class, 'archive']);
