...
class ReligionRepository implements MasterDataRepositoryInterface
{
    public function __construct(private readonly Religion $model) {}
    ...
    public function update(int $id, array $data): Model
    {
        ...
        if ($record === null) {
            throw (new ModelNotFoundException)->setModel(Religion::class, $id);
        }
