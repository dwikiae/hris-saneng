...
class PositionRepository implements MasterDataRepositoryInterface
{
    public function __construct(private readonly Position $model) {}
    ...
    public function update(int $id, array $data): Model
    {
        ...
        if ($record === null) {
            throw (new ModelNotFoundException)->setModel(Position::class, $id);
        }
