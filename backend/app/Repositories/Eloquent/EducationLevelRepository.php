...
class EducationLevelRepository implements MasterDataRepositoryInterface
{
    public function __construct(private readonly EducationLevel $model) {}
    ...
    {
        /** @var EducationLevel|null $record */
    ...
    public function update(int $id, array $data): Model
    {
        ...
        if ($record === null) {
            throw (new ModelNotFoundException)->setModel(EducationLevel::class, $id);
        }
