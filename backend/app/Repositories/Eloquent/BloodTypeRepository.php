...
class BloodTypeRepository implements MasterDataRepositoryInterface
{
    public function __construct(private readonly BloodType $model) {}
    ...
    public function update(int $id, array $data): Model
    {
        ...
        if ($record === null) {
            throw (new ModelNotFoundException)->setModel(BloodType::class, $id);
        }
