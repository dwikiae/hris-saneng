...
class MaritalStatusController extends MasterDataController
{
    public function __construct(private readonly MaritalStatusService $service) {}
    ...
    public function store(Request $request): JsonResponse
    {
        $validated = $request->validate([
            'code' => [
                ...
                Rule::unique('marital_statuses', 'code')
